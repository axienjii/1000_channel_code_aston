function align_resting_state_aston(date)
...
for instanceInd=1:8
    ...
    instanceNEVFileName=['F:\aston_new_data_170419_onwards\',date,'\',instanceName,'.nev'];
...
switch date
    case '140819_B1_aston_resting_state'
        load('D:\aston_data\140819_B1_aston_resting_state\140819_data\sync_pulse_resting_state_140819_B1_aston.mat')
    case '150819_B1_aston_resting_state';
        load('D:\aston_data\150819_B1_aston_resting_state\150819_data\sync_pulse_resting_state_150819_B1_aston.mat')
    case '160819_B1_aston_resting_state';
        load('D:\aston_data\160819_B1_aston_resting_state\160819_data\sync_pulse_resting_state_160819_B1_aston.mat')   
end
...
if alignData==1
    for instanceInd=1:4
        ...
        if instanceInd==1
            ...
            save(['D:\aston_data\',date,'\eye_data.mat'],'eyeData');
        end
        NSchNew=NSch.Data(1:128,startShared:stopShared);
        NSch.Data=NSchNew;
        NSch.MetaTags.ChannelID=[1:128]';
        NSch.MetaTags.ChannelCount=128;
        newInstanceNS6FileName=['D:\aston_data\',date,'\',instanceName,'_aligned.ns6']
