function render_orientation_task_aston(movieVersion)
...
%                 FrameData(:,:,:,totalFrame) = X;
        ...
        pathname=['D:\aston_data\ori_video_in_setup\setup 1024-channel ori',num2str(movieVersion),'.mat'];
    ...
    if makeIndividualMovies==1
        ...
        moviename=['D:\aston_data\ori_video_in_setup\setup 1024-channel ori',num2str(movieVersion),'.avi'];
        ...
        moviename=['D:\aston_data\ori_video_in_setup\setup 1024-channel ori',num2str(movieVersion)];
