function [Tuning_Amplitude,Width,Perc_Var_acc, Prefered_Ori, Bandwidth, Baseline_FR, pFit]=Wrapped_Gaus_strf(Response,STD,chInd)
...
% %     Wrapped Gaussian -5 to 5
    ...
    ptext=sprintf(',  ori= %.0f var acc= %.0f',Prefered_Ori,Perc_Var_acc);
