function analyse_microstim_line_across_sessions_5phosphenes_2point5(date)
%27/2/18
...
pathname=fullfile('D:\data\5phosphene_2point5_behavioural_performance_all_sets_260218');
set(gcf,'PaperPositionMode','auto','Position',get(0,'Screensize'))
print(pathname,'-dtiff');

perfMat=['D:\data\5phosphene_2point5_behavioural_performance_all_sets_260218_',num2str(initialPerfTrials),'trials.mat'];
