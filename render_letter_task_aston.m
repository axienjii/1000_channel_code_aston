function render_letter_task_aston(movieVersion)
...
for monkeyInd=2
    ...
    if drawFrames==1
        if monkeyInd==2
            switch(movieVersion)
                case 1
                    datapath = 'D:\aston_data\080219_B10_aston\eye_data_080219_B10_aston.mat';%setNo 7
                case 2
                    datapath = 'D:\aston_data\110219_B6_aston\eye_data_110219_B6_aston.mat';%setNo 8
                case 3
                    datapath = 'D:\aston_data\120219_B6_aston\eye_data_120219_B6_aston.mat';%setNo 10
            end
        end
        load(datapath)
...
%             thisCond = targetLocationsFinal(thisTrialIdx)
            ...
            for thisDP = 1:TrueSampleRate/movieFrameRate:numDP%30 kHz/1000 = 30 fps
                ...
                if thisDP/TrueSampleRate >= (300+400)/1000 && thisDP/ TrueSampleRate <= (300+400+700)/1000 && targetAcquiredFlag==0                  
                    text(-20,200, 'L','FontSize',16,'FontName','Sloan','Color',[0.75 0.75 0])%up
                    text(200,-20, 'T','FontSize',16,'FontName','Sloan','Color',[0.75 0.75 0])%right             
                end
...
%                 FrameData(:,:,:,totalFrame) = X;
        ...
        pathname=['D:\aston_data\letter_video_in_setup\setup 1024-channel letter',num2str(movieVersion),'.mat'];
    ...
    if makeIndividualMovies==1
        ...
        moviename=['D:\aston_data\letter_video_in_setup\setup 1024-channel letter',num2str(movieVersion),'.avi'];
        ...
        moviename=['D:\aston_data\letter_video_in_setup\setup 1024-channel letter',num2str(movieVersion)];
