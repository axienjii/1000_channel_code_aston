...
pathname=fullfile('D:\data\behavioural_performance_all_sets_221217_familiar');
set(gcf,'PaperPositionMode','auto','Position',get(0,'Screensize'))
print(pathname,'-dtiff');

perfMat=['D:\data\behavioural_performance_all_sets_221217_',num2str(initialPerfTrials),'trials_familiar.mat'];
