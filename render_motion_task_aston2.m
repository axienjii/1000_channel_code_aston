function render_motion_task_aston2(movieVersion)
...
%                 FrameData(:,:,:,totalFrame) = X;
        ...
        pathname=['D:\aston_data\motion_video_in_setup\setup 1024-channel motion',num2str(movieVersion),'_2.mat'];
    ...
    if makeIndividualMovies==1
        ...
        moviename=['D:\aston_data\motion_video_in_setup\setup 1024-channel motion',num2str(movieVersion),'_2.avi'];
        ...
        moviename=['D:\aston_data\motion_video_in_setup\setup 1024-channel motion',num2str(movieVersion),'_2'];
