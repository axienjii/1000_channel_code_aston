function analyse_microstim_line_across_sessions_5phosphenes_familiar_int(date)
%22/12/17
    ...
    for setNo=[1 3:20]%1:10
        ...
        if processRaw==1
            for instanceCount=1%:length(allInstanceInd)
                ...
                initialPerfTrials=40;%first set of trials are the most important
                if calculateVisual==0
...
pathname=['D:\data\behavioural_performance_all_sets_221217_',num2str(initialPerfTrials),'trials_5_phosphenes_familiar_interleave'];
set(gcf,'PaperPositionMode','auto','Position',get(0,'Screensize'))
print(pathname,'-dtiff');

perfMat=['D:\data\behavioural_performance_all_sets_221217_',num2str(initialPerfTrials),'trials_5_phosphenes_familiar_interleave.mat'];
