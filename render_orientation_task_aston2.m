function render_orientation_task_aston2(movieVersion)
...
for monkeyInd=2
    if monkeyInd==1%Lick
        A = imread('X:\best\barsweep_video_in_setup\lick_realistic_skin_intact11_2.jpg');
    ...
    if drawFrames==1
        if monkeyInd==2
            switch(movieVersion)
                case 1
                    datapath = 'D:\aston_data\191118_B7_aston\eye_data_191118_B7_aston.mat';%setNo 3
                case 2
                    datapath = 'D:\aston_data\221118_B11_aston\eye_data_221118_B11_aston.mat';%setNo 7
            end
        end
        load(datapath)
...
%             thisCond = targetLocationsFinal(thisTrialIdx)
            ...
            for thisDP = 1:TrueSampleRate/movieFrameRate:numDP%30 kHz/1000 = 30 fps %24001
                copyA2=copyA;
                hold off
                ...
                % plot targets
                if thisDP/TrueSampleRate >= (300+400)/1000 && thisDP/ TrueSampleRate <= (300+400+500)/1000 && targetAcquiredFlag==0
                    ...
                    switch(movieVersion)
                        ...
                        case 2
                            plot(-15,-180,'.','color',[0 0 0],'markersize',20)%draw targets on screen (lower left)
                            plot(15,-180,'.','color',[0 0 0],'markersize',20)%draw targets on screen (lower right)
                    end
                end
...
%                         if xInd>30&&xInd<325&&yInd>250&&yInd<340
                        if xInd>30&&xInd<300&&yInd>50&&yInd<500
                            targetsArea=1;
...
%                 FrameData(:,:,:,totalFrame) = X;
        ...
        pathname=['D:\aston_data\ori_video_in_setup\setup 1024-channel ori',num2str(movieVersion),'_2.mat'];
    ...
    if makeIndividualMovies==1
        ...
        moviename=['D:\aston_data\ori_video_in_setup\setup 1024-channel ori',num2str(movieVersion),'_2.avi'];
        ...
        moviename=['D:\aston_data\ori_video_in_setup\setup 1024-channel ori',num2str(movieVersion),'_2'];
